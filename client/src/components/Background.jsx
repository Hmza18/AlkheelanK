// Ambient blue backdrop with soft glows + floating answer shapes.
...
const FLOATERS = [
  ...
  { type: "circle", color: "#60a5fa", top: "22%", left: "82%", size: 64, delay: "0.8s" },
...
export default function Background() {
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden bg-surface">
      <div className="absolute -left-40 -top-40 h-96 w-96 rounded-full bg-blue-300/35 blur-3xl" />
      <div className="absolute -right-32 top-1/3 h-96 w-96 rounded-full bg-blue-400/25 blur-3xl" />
      <div className="absolute bottom-0 left-1/3 h-96 w-96 rounded-full bg-brand-mid/12 blur-3xl" />
      {FLOATERS.map((f, i) => (
        <div
          key={i}
