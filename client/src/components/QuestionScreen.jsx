...
export default function QuestionScreen({
  ...
  const mediaClass = image ? "question-screen--with-image" : "question-screen--without-image";
  ...
  return (
    <div className={`${rootClass} ${mediaClass} ${className}`.trim()} data-question-key={questionKey}>
      {timerStrip}
