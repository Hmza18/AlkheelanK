...
export function starterCover(emoji, accent, subtitle = "") {
  ...
  <defs>
    <linearGradient id="bg" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <stop offset="55%" stop-color="#1d1e52"/>
      <stop offset="100%" stop-color="#15163d"/>
    </linearGradient>
  ...
  ${
    subtitle
      ? `<text x="320" y="248" font-family="system-ui,sans-serif" font-size="28" font-weight="700" fill="#f5f6ff" fill-opacity="0.85" text-anchor="middle">${subtitle}</text>`
      : ""
  }
</svg>`;
