...
Write-Host "Redirect URLs (add every line):"
Write-Host "  https://YOUR-VERCEL-URL.vercel.app/login"
Write-Host "  https://YOUR-VERCEL-URL.vercel.app/host"
Write-Host "  http://localhost:5173/login"
Write-Host "  http://localhost:5173/host"
Write-Host ""
Write-Host "Optional Vercel env (recommended for OAuth):"
Write-Host "  VITE_SITE_URL=https://YOUR-VERCEL-URL.vercel.app"
Write-Host ""
